...
class DirectPromptAgent:
    def __init__(self, openai_api_key: str):
        # 1) store the key FIRST
        self.openai_api_key = openai_api_key

        # 2) get base URL (Vocareum)
        base_url = os.getenv("OPENAI_BASE_URL", "https://openai.vocareum.com/v1")

        # 3) create client using the stored key
        self.client = OpenAI(
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                # TODO: 3 - Add a system prompt instructing the agent to assume the defined persona and explicitly forget previous context.
                {
                    "role": "system",
                    "content": (
                        "Forget any previous conversational context. Treat this as a new conversation.\n"
                        f"You must follow this persona exactly: {self.persona}"
                    ),
                },
...
class EvaluationAgent:
    ...
    def evaluate(self, initial_prompt):
        ...
        for i in range(self.max_interactions):# TODO: 2 - Set loop to iterate up to the maximum number of interactions:
            ...
            response = client.chat.completions.create(
                model="gpt-3.5-turbo",
                # TODO: 5 - Define the message structure (temperature=0)
                messages=[
                    {"role": "system", "content": f"You are {self.persona}, a knowledge-based assistant. Forget previous context."},
            ...
            if evaluation.lower().startswith("yes"):
                ...
                response = client.chat.completions.create(
                    ...
                    temperature=0,
                    messages=[
                        {"role": "system", "content": "You generate correction instructions."},
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        for line in raw_lines:
            ...
            # remove simple bullet/number prefixes: "1. ", "2) ", "- ", "* "
